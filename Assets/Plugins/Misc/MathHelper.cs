...
namespace Plugins
{
    ...
    /// <summary>
    ///     The MathHelper contains methods to help with mapping and angles and a really nifty method for framerate-independent
    ///     eased lerping.
    /// </summary>
    public static class MathHelper
    {
        ...
        /// <param name="fullRangeBetweenDeadzoneAndOne">
        ///     If this is true, the values between [-1..-deadzone] and [deadzone..1] will
        ///     be mapped to [-1..0] and [0..1] respectively.
        /// </param>
            ...
            bool fullRangeBetweenDeadzoneAndOne = false)
        {
            ...
            if (!fullRangeBetweenDeadzoneAndOne || !(deadzone > 0f)) return value;
            return value < 0 ? MapClamped(value, -1f, -deadzone, -1f, 0f) : MapClamped(value, deadzone, 1f, 0f, 1f);
        }
